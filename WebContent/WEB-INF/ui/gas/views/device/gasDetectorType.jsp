...
<body>
  ...
  layui.config({
    ...
    table.render({
      ...
      ,url: 'device/getGasDetectorTypeListByPage'
      ...
      ,cols: [[
        ...
        ,{field:'communicationMode', title:'通信模式',  edit: 'text'}
        ,{field:'gasType', title:'气体类型'}
        ,{field:'measureUnit', title:'测量单位', sort: true}   
        ,{field:'measureRange', title:'测量范围'}
        ,{field:'resolutionRatio', title:'分辨率',sort: true}
 
        ,{field:'lowAlarm', title:'低限报警'}
        ,{field:'highAlarm', title:'高限报警',sort: true}        
