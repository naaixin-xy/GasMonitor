...
public class PcmSession implements Serializable {
	...
	private String hostId; // session对应的主机ID
	private String detectorId; // session对应的探测器ID
...
//  将键为 key，值为 value的用户自定义的属性存储到 I/O 会话中。
	 ...
	 * IoHandler.messageSent(IoSession,Object)会被调用。如果需要的话， 也可以等消息真正发送出去之后再继续执行后续操作。
	 */
	...
	public String toString() {
		return "PcmSession [gid=" + gid + ", nid=" + nid + ", hostId=" + hostId + ", detectorId=" + detectorId
				+ ", host=" + host + ", bindTime=" + bindTime + ", heartbeat=" + heartbeat + "]";
	}
