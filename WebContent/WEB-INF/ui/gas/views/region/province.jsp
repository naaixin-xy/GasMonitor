...
<body>
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">省级行政区域列表</div>
  ...
  layui.config({
    ...
    table.render({
      ...
      ,url: 'region/getProvinceListByPage'
      ...
      ,cols: [[
        ...
        ,{field:'provinceId', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
        ,{field:'provinceCode', title:'省级代码', width:100, edit: 'text'}
        ,{field:'provinceName', title:'省级名称', width:140, edit: 'text'}
