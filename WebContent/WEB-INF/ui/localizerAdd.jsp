...
<div class="main">
    ...
    <p class="long-input ue-clear">
    	<label>设备名：</label>
        <input type="text" id="name" placeholder="不能为空，且只能是4-10位字母汉字数字或者下划线" />
    </p>
    <p class="long-input ue-clear">
    	<label>设备电话：</label>
        <input type="text" id="phone"  placeholder="不能为空，且只能是5-20位数字" />
    </p>
    <p class="long-input ue-clear">
    	<label>车牌号：</label>
        <input type="text" id="plateNumber" placeholder="示例车牌：京A88888" />
    </p>  
    <p class="long-input ue-clear">
    	<label>速度限制：</label>
        <input type="text" id="speedLimit" placeholder="三位以内数字，单位公里" />
    </p>
    <p class="long-input ue-clear">
    	<label>联系电话：</label>
        <input type="text" id="contactPhone" placeholder="不能为空，且只能是5-20位数字"/>
    </p>
    <p class="long-input ue-clear">
    	<label>油耗：</label>
        <input type="text" id="oilCoefficient" placeholder="1000以内整数或者小数" />
    </p>
    
     <p class="long-input ue-clear">
    	<label>保养周期：</label>
        <input type="text" id="maintainDistancePeriod" placeholder="6位以内整数" />
    </p>   
     <p class="long-input ue-clear">
    	<label>上次保养：</label>
        <input type="text" id="lastMaintainKilometre" placeholder="8位以内整数" />
    </p>   
     <p class="long-input ue-clear">
    	<label>过滤LBS：</label>
    ...
    <p class="long-input ue-clear">
    	<label>设备联系人：</label>
        <input type="text" id="deviceContact"  placeholder="不能为空，且只能是2-10位字母汉字数字或者下划线" />
    </p>
    <p class="long-input ue-clear">
    	<label>用户ID：</label>
...
<!--     </p> -->
     <div class="long-input select ue-clear">
        ...
        <div class="select-wrap">
        	<div class="select-title ue-clear"><span id="deviceStatus">0-库存</span><i class="icon"></i></div>
...
<!--     </p>      -->
     ...
     <div class="long-input select ue-clear">
    	<label>连接状态：</label>
        <div class="select-wrap">
        	<div class="select-title ue-clear"><span id="connectStatus">0-离线</span><i class="icon"></i></div>
            <ul class="select-list">
            	<li>0-离线</li>
                <li>1-在线</li>
            </ul>
    ...
    <p class="long-input ue-clear"> 
    	<label>IMEI：</label>
        <input type="text" id="deviceImei" placeholder="模块IMEI" />
    </p>
<!--     <p class="long-input ue-clear"> -->
<!--     	<label>设备类型 ：</label> -->
...
<!--     </p> -->
     ...
     <div class="long-input select ue-clear">
    	<label>设备类型：</label>
        <div class="select-wrap">
        	<div class="select-title ue-clear"><span id="deviceCategory">0-私家车</span><i class="icon"></i></div>
            <ul class="select-list">
             	<li>0-私家货</li>           
            	<li>1-厢货</li>
                <li>2-客车</li>
    ...
    <p class="icon-input ue-clear">
	      <label>设备图标 ：</label>
	      <input type="radio" value="0" id="equipicon" name="deviceIcon" checked><img src="ui/oimgs/deviceicon/deviceicon1.gif" /></input>
...
$(function (){
	...
	$(".confirm").on("click",function(){
		...
		var postParameter={
				...
				deviceIcon:$("#deviceIcon").attr("value"),
