...
<%
	String path = request.getContextPath()+"/module01";
...
<p>request 参数：${req}</p>
<p>session 参数：${session}</p>
<p>sessionParam 参数：${sessionParam}</p>
<p>session 比较结果：${sessionCompare}</p>
<p>application 参数：${application}</p>
<img src="/localizer/ui/getIdentifyingCode" width=120pt height=30pt/>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">安福在线监控平台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v2.4</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
