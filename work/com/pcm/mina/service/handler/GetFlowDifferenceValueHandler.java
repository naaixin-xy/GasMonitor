 ...
 * @Description  推送消息
 */ 
public class GetFlowDifferenceValueHandler implements RequestHandler {

    protected final Logger logger = Logger.getLogger(GetFlowDifferenceValueHandler.class);
