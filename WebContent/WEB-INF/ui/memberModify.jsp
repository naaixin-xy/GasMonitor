...
<div class="main">
    <p class="long-input ue-clear">
    	<label>用户ID：</label>
        <input type="text" id="id" value="${members[0].id}" disabled="disabled"/>
    </p>
    <p class="long-input ue-clear">
    	<label>帐户：</label>
        <input type="text" value="${members[0].account}"  id="account" />
    </p>
    <p class="long-input ue-clear">
    	<label>密码：</label>
        <input type="password" value="${members[0].password}"  id="password"/>
    </p>
    <p class="long-input ue-clear">
    	<label>确认密码：</label>
        <input type="password" id="password2"  value="${members[0].password}"  />
    </p>
    <div class="short-input select ue-clear">
    	<label>类别：</label>
        <div class="select-wrap">
        	<div class="select-title ue-clear"><span id="category">
<%--         		<c:if test="${mapitem.hm_status == '禁用'}"> --%>
  				<c:if test="${members[0].category==1}">
  					代理商
  				</c:if>
  				<c:if test="${members[0].category==0}">
  					用户
  				</c:if>  				
        	</span><i class="icon"></i></div>
    ...
    <p class="long-input ue-clear">
    	<label>姓名</label>
        <input type="text" value="${members[0].name}" id="name"/>
    </p>
    <p class="long-input ue-clear">
    	<label>上级用户</label>
        <input type="text" disabled="disabled" value="${members[0].parentId}" id="parentId"/>
    </p>
    <p class="short-input ue-clear">
    	<label>电话：</label>
        <input type="text" value="${members[0].phone}"  id="phone"/>
    </p>
    
     <p class="short-input ue-clear">
    	<label>设备数量：</label>
        <input type="text" value="${members[0].deviceCount}" id="deviceCount"/>
    </p>   
     <p class="short-input ue-clear">
    	<label>联系人：</label>
        <input type="text" value="${members[0].contact}"  id="contact" />
    </p> 
   	<p class="short-input ue-clear">
    	<label>库存：</label>
    ...
    <p class="short-input ue-clear">
    	<label>备注：</label>
        <textarea id="remark">${members[0].remark}  </textarea>
    </p>
