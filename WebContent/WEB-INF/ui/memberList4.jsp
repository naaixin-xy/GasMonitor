...
<body>
		...
		<div style="margin-left: 15%; width: 85%" id="right-div">
			<div id="right-div-up">
				<div class="table-operate ue-clear">
					<a href="javascript:;" class="add">添加</a> <a href="javascript:;" class="del">删除</a> <a href="javascript:;" class="edit">编辑</a> <a href="javascript:;" class="count">全选选择</a> <a href="javascript:;" class="check">审核</a> <a id="test" οnclick="clickDownload(this)" download="downlaod.csv" href=" ">download</a> 
				</div>
				<div class="table-box">
					<table>
						<thead>
	...
	<button type="button" class="btn btn-primary click">鼠标左键点击我</button> 
	<button type="button" class="btn btn-success context">鼠标右键点击我</button> 
	<button type="button" class="btn btn-info touchend">Touch me! (移动端手机有效)</button>
</body>
...
<script type="text/javascript" src="ui/js/lib/basicContext.min.js"></script>
