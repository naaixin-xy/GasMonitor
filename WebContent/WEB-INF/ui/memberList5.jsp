...
<%-- 												<td class="w100">${itema.password}</td> --%>
			            ...
			            <div class="matter-content ue-clear">
							<div class="table-operate ue-clear">
								<a href="javascript:;" class="add1">添加</a> 
								<a href="javascript:;" class="del1">删除</a> 
								<a href="javascript:;" class="edit1">编辑</a> 
								<a href="javascript:;" class="count1">全选选择</a> 
								<a href="javascript:;" class="check1">审核</a> 
							</div>
							<div class="table-box">
								<table>
									<thead>
...
<%-- 												<td class="w100">${itema.password}</td> --%>
		            ...
		            <div class="matter-content ue-clear">
		            	<div id="userInfoDiv" class="main" style="padding:60px 300px 0px 300px;">
						...
						<div class="btn1 ue-clear" style="padding-left:460px">
		...
		var setting = {
			...
			callback : {
				...
				onClick:function(e,treeId, treeNode) {
					...
					//alert(treeNode.getPath());
					 //showMenu(e);
					// alert(JSON.stringify(treeNode.children));
					// $("#testshow").text(JSON.stringify(treeNode.children));
				}
			}
		}
		var zNodes = [];
...
// 		$('.touchend').on('touchend', onClick)  
	...
	function showUserInfo(result){
		...
		var pHeadInfo = "<p class=\"short-input ue-clear newstyle\"><label>";
		var usertype;
	...
	function showMenu(e,treeNode) {    
		...
		var items = [
			...
			{ title: '客户转移', icon: 'ion-log-out', fn: clicked },   
			{}, 
			{ title: '离线设置', icon: 'ion-log-out', fn: clicked }    
		]    
