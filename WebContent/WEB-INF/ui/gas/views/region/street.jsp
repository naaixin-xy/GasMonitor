...
<body>
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">镇级行政区域列表</div>
  ...
  layui.config({
    ...
    table.render({
      ...
      ,url: 'region/getStreetListByPage'
      ...
      ,cols: [[
        ...
        ,{field:'streetId', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
        ,{field:'streetCode', title:'街道代码', width:100, edit: 'text'}
        ,{field:'streetName', title:'街道名称', width:140, edit: 'text'}
        ,{field:'shortName', title:'简称', width:80, edit: 'text', sort: true}
        ,{field:'areaCode', title:'县区代码', width:100}
        ,{field:'lng', title:'经度'}
