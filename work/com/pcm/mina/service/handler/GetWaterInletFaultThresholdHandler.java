 ...
 * @Description  推送消息
 */ 
public class GetWaterInletFaultThresholdHandler implements RequestHandler {

    protected final Logger logger = Logger.getLogger(GetWaterInletFaultThresholdHandler.class);
