 ...
 * @Description  推送消息
 */ 
public class SetWaterInletFaultThresholdHandler implements RequestHandler {

    protected final Logger logger = Logger.getLogger(SetWaterInletFaultThresholdHandler.class);
