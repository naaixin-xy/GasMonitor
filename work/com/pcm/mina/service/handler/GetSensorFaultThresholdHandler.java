 ...
 * @Description  推送消息
 */ 
public class GetSensorFaultThresholdHandler implements RequestHandler {

    protected final Logger logger = Logger.getLogger(GetSensorFaultThresholdHandler.class);
