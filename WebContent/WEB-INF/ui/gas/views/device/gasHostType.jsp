...
<body>
  ...
  layui.config({
    ...
    table.render({
      ...
      ,url: 'device/getGasHostTypeListByPage'
      ...
      ,cols: [[
        ...
        ,{field:'name', title:'设备名称', edit: 'text'}
        ,{field:'maxDetectorCount', title:'最大探测器数量', edit: 'text'}
        ,{field:'commnicationMode', title:'通信模式'}
        ,{field:'uploadMode', title:'上传模式', sort: true}  
