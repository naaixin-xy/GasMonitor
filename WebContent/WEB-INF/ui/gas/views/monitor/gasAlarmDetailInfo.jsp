        ...
        <div class="layui-row layui-col-space15">
          <div class="layui-col-md6">
            <div class="layui-card">
              <div class="layui-card-header">设备操作</div>
                ...
                <div class="layui-carousel layadmin-carousel layadmin-shortcut">
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      ...
                      <li class="layui-col-xs3">
                        <a href="javascript:" class="layui-alarminfo-exit">
...
<!--                     </ul> -->
          ...
          <div class="layui-col-md6">
            <div class="layui-card">
              <div class="layui-card-header">设备历史信息</div>
              <div class="layui-card-body">
...
<!--                     <div></div> -->
                ...
                <tr>
                  ...
                  <td style="padding-bottom: 0;">
                    <div class="layui-btn-container">
                      <a href="" target="_blank" class="layui-btn layui-btn-danger">查看地图</a>
                      <a href="" target="_blank" class="layui-btn">查看平面图</a>
                    </div>
                  </td>
                </tr>
              </tbody>
  ...
  }).use(['index', 'layer','alarminfo'],function(){
	  var $ = layui.$;
	  layer=layui.layer;
	  $(".layui-alarminfo-exit").on("click",function(){
		  //alert("关闭");
