          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="console">
                  <a lay-href="settings/stack.html">参数设置页面</a>
                </dd>
                <dd data-name="console">
                  	<a lay-href="localizerAdd">主页三</a>
                </dd>
              </dl>
            </li>
             <li data-name="province" class="layui-nav-item">
              <a href="javascript:;" lay-tips="区域" lay-direction="2">
                <i class="layui-icon layui-icon-area"></i>
                <cite>区域管理</cite>
              </a>
              <dl class="layui-nav-child">
                <dd data-name="province" class="layui-this">
                  <a lay-href="province">省级区域</a>
                </dd>
                <dd data-name="coprovincensole">
                  <a lay-href="city">市级区域</a>
                </dd>
                <dd data-name="province">
                  <a lay-href="area">县级区域</a>
                </dd>
                <dd data-name="province">
                  <a lay-href="street">镇及街道</a>
                </dd>
              </dl>
            </li>
            </li>
            <li data-name="enterprise" class="layui-nav-item">
              <a href="javascript:;" lay-tips="区域" lay-direction="2">
                <i class="layui-icon layui-icon-component"></i>
                <cite>机构管理</cite>
              </a>
              <dl class="layui-nav-child">
                <dd data-name="enterprise" class="layui-this">
                  <a lay-href="enterprise">组织机构或企业列表</a>
                </dd>
                <dd data-name="enterprise">
                  <a lay-href="subArea">分区列表</a>
                </dd>               
              </dl>
            </li>   
            <li data-name="administrator" class="layui-nav-item">
              <a href="javascript:;" lay-tips="区域" lay-direction="2">
                <i class="layui-icon layui-icon-component"></i>
                <cite>管理员管理</cite>
              </a>
              <dl class="layui-nav-child">
                <dd data-name="administrator" class="layui-this">
                  <a lay-href="administrator">管理员列表</a>
                </dd>
                <dd data-name="administrator">
                  <a lay-href="subArea">分区列表</a>
                </dd>               
              </dl>
            </li>                          
            ...
            <li data-name="device" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="device" class="layui-this">
                  <a lay-href="gasDetector">探测器列表</a>
                </dd>
                <dd data-name="device">
                  <a lay-href="gasHost">主机列表</a>
                </dd>
                <dd data-name="device" class="layui-this">
                  <a lay-href="gasDetectorType">探测器类型</a>
                </dd>
                <dd data-name="device">
                  <a lay-href="gasHostType">主机类型</a>
                </dd>                
              </dl>
            </li>   
            ...
            <li data-name="monitor" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="monitor" class="layui-this">
                  <a lay-href="gasAlarm">报警信息列表</a>
                </dd>
                <dd data-name="monitor">
                  <a lay-href="gasFault">故障信息列表</a>
                </dd>
                <dd data-name="monitor" class="layui-this">
                  <a lay-href="gasData">数据信息列表</a>
                </dd>            
              </dl>
            </li>             
