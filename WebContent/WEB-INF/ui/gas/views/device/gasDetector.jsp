      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body">
                <div class="layui-carousel layui-gasdetector-carousel" data-anim="fade" lay-filter="LAY-index-dataview">
...
//				skin: 'layui-layer-lan',
   ...
   $(".layui-gasdetector-carousel").height($(window).height()-100);
   //$("#container").height(1000);
    ...
    //轮播切换
    $('.layui-gasdetector-carousel').each(function(){
      var othis = $(this);
      carousel.render({
        elem: this
        ,width: '100%'
