 ...
 * @Description  推送消息
 */ 
public class SetSensorFaultThresholdHandler implements RequestHandler {

    protected final Logger logger = Logger.getLogger(SetSensorFaultThresholdHandler.class);
